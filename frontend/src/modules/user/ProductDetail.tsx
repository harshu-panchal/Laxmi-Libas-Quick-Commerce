...
export default function ProductDetail() {
  ...
  const handleWhatsAppEnquiry = () => {
    ...
    const sellerMobile = (product as any).contactNumber ||
    ...
    const whatsappUrl = `https://wa.me/${sellerMobile.startsWith('91') ? sellerMobile : '91' + sellerMobile}?text=${encodeURIComponent(message)}`;
          ...
          <div className="ml-3 flex items-center">
            {isRoomRent ? (
              <Button
                ...
                className="px-6 py-2 text-sm font-semibold h-[36px] bg-[#25D366] hover:bg-[#128C7E] text-white flex items-center gap-2 border-none">
