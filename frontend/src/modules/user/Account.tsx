    ...
    <div className="pb-24 md:pb-8 bg-white min-h-screen">
      ...
      <div className="px-4 py-2.5">
        ...
        <div className="bg-white rounded-lg border border-neutral-200 overflow-hidden divide-y divide-neutral-100">
          ...
          <button onClick={() => window.location.href = 'https://about.laxmart.com'} className="w-full flex items-center justify-between px-3 py-3 hover:bg-neutral-50 transition-colors">
            <div className="flex items-center gap-3">
